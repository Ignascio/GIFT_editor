...
public class FileIO
{
    ...
    */
   public FileIO(String fileName, int operation) throws FileNotFoundException
   {
      try
      {
         ...
         {
            throw new FileNotFoundException("Must specify reading or writing.");
         }

         File file = new File(fileName);  //throws FileNotFoundException only (not IOException anymore)
      ...
      {
         throw new FileNotFoundException("Problem with file.");
      }
   }
    ...
    */
   public FileIO(String fileName, String delimiter) throws FileNotFoundException
   {
      try
      {
         setting = FOR_READING;
    ...
    */
   public Iterator<String> getTokens() throws FileNotFoundException
   {
      ...
      {
         throw new FileNotFoundException("Tokens not available.");
      }
   ...
   public String readLine() throws FileNotFoundException
   {
      ...
      try
      {
         ...
         {
            throw new FileNotFoundException("File is not open for reading.");
         }
      }
      catch (IOException ioe)
      {
   ...
   public void writeLine(String line) throws FileNotFoundException
   {
      ...
      {
         throw new FileNotFoundException("File is not open for writing.");
      }
